export default function Footer() {
  return (
    <footer role="contentinfo" className="relative z-10 flex flex-col items-center justify-center py-8 px-4 text-center overflow-hidden safe-area-bottom border-t border-[var(--color-medium-gray)]/60">
      ...
      <div className="relative z-20 max-w-4xl mx-auto px-4 text-center">
        <div className="glass-mono rounded-xl px-4 sm:px-5 py-4 sm:py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-[var(--color-accent-gray)] text-xs sm:text-sm tracking-[0.01em]">
            ...
            <ul className="flex gap-4 list-none">
              <li>
                <a
                  ...
                  className="flex items-center gap-2 text-[var(--color-accent-gray)] hover:text-[var(--color-nothing-red)] transition-colors text-xs uppercase tracking-[0.1em] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-white)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-off-black)] rounded px-2 py-1 min-h-[36px] min-w-[36px]"
                >
