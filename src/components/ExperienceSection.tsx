    ...
    >
      <div className="space-y-4 sm:space-y-6">
        {experience.map((exp, index) => {
          const isContinuedRole = index > 0 && experience[index - 1].company === exp.company
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-3">
                <div className="flex-1 min-w-0">
                  {isContinuedRole && (
                    <div className="mb-1 flex items-center text-[10px] uppercase tracking-[0.24em] text-[var(--color-accent-gray)]">
                      <span className="mr-2 h-px w-4 bg-[var(--color-accent-gray)]" />
                      Continued role
                    </div>
                  )}
